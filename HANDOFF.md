...
- Instance: c7a.48xlarge SPOT, i-016786d5b788d3a12, us-east-2c (relaunched from AMI 2026-08-03 after 2b interruption; c8a was dry region-wide), Elastic IP 3.20.175.238 (stable across spot stop/start), ~$3.54/hr (2a had no capacity), persistent spot + stop-on-interrupt, 200GB gp3, SG gamut-ssh (sg-0b1b15deb810aa8ad, SSH only from 97.120.254.99). Key: ~/Downloads/gamut-key.pem. Expect ~$170-200 total over ~2-3 days.
...
- BOX B (2026-08-04, relaunched 2026-08-05): c6a.24xlarge i-03cdd4c4b1ef62f78, us-east-2c, Elastic IP 18.117.41.39, ~$1.35/hr. AZ-move attempted 2026-08-05 (monitor): old B (i-0c96467bf069096b8, sir-2njqjchq) cancelled+terminated, but NO spot capacity for c6a/c7a/c8a.24xlarge in 2a or 2b — relaunched from AMI in 2c, EIP re-associated, re-armed via offload_watch.sh. Skip further move attempts today. — runs the MAIN plan in REVERSE (jobs=6, meet-in-middle with box A). Spot quota now 300 vCPU (288 used). Sync loop covers both boxes (pull runs + push done-markers both ways); Progress page merges worker_state*.json.
